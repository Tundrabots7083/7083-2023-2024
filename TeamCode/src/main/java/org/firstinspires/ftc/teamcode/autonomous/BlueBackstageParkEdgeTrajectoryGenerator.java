...
public class BlueBackstageParkEdgeTrajectoryGenerator implements TrajectoryGenerator {
    ...
    public static final Pose2d BACK_STAGE_PARKING_POSITION = new Pose2d(59, 63, Math.toRadians(180));

    TeamElementLocation targetLocation;

    public BlueBackstageParkEdgeTrajectoryGenerator(TeamElementLocation targetLocation) {
