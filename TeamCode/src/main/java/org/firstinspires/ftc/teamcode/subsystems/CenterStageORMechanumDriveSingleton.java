...
public class CenterStageORMechanumDriveSingleton extends Drive {
    private static CenterStageORMechanumDriveSingleton instance;
    ...
    public CenterStageORMechanumDriveSingleton(HardwareMap hardwareMap, LinearOpMode opMode, GlobalStoreSingleton globalStore) {
    ...
    public static CenterStageORMechanumDriveSingleton getInstance(HardwareMap hardwareMap, LinearOpMode opMode, GlobalStoreSingleton globalStore) {
        if (instance == null) {
            instance = new CenterStageORMechanumDriveSingleton(hardwareMap, opMode, globalStore);
        }
        return instance;
    }
