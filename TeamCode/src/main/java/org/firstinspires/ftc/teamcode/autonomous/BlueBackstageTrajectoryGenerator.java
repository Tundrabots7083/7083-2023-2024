...
public class BlueBackstageTrajectoryGenerator implements TrajectoryGenerator {
    ...
    public static final Vector2d BACKDROP_INTERMEDIATE_POSITION = new Vector2d(40.5, 46);
    public static final Vector2d BACKDROP_EDGE_POSITION = new Vector2d(40.5, 43);
    public static final Vector2d BACKDROP_MIDDLE_POSITION = new Vector2d(40.5, 37);
    public static final Vector2d BACKDROP_CENTER_POSITION = new Vector2d(40.5, 31);
    ...
    public static double BACKDROP_FORWARD_DISTANCE = 5;
    public static double BACKDROP_BACKWARD_DISTANCE = 2.15;

    public static final Vector2d REVERSE_POSITION = new Vector2d(27, 59);
    public static final Vector2d INTERMEDIATE_PARKING_POSITION_CENTER = new Vector2d(52, 15);
    public static final Vector2d INTERMEDIATE_PARKING_POSITION_EDGE = new Vector2d(52, 63);
    ...
    public Trajectory toArmLiftPosition(TrajectoryBuilder builder) {
        ...
        builder.splineTo(BACKDROP_INTERMEDIATE_POSITION, Math.toRadians(0));
